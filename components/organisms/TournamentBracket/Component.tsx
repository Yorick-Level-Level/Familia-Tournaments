...
export default function TournamentBracket (): JSX.Element {
    ...
    return (
        <div className='mt-6 md:mt-12 w-full md:max-w-4xl text-custom-blue'>
            ...
            <p className='pt-2'>Mocht je nog leuke ideeën of suggesties hebben voor het toernooi zijn die uiteraard welkom. <span className='italic'><br />&quot;Wat nou als ik niet wil deelnemer als speler maar wel als publiek? En wel aanwezig wil zijn bij de borrel en eten?&quot;</span> Dan ben je ontzettend welkom! De spelers hebben zeker aanmoediging nodig! Maar laat het dan wel even van te voren weten aan Karin.</p>
        </div>
    );
};
